...
const DICT = {
  ru: {
    ...
    'ai.noKey': 'ИИ: ключ API не задан',
    'ai.badKey': 'ИИ: ключ не принят (401) - проверьте его в настройках',
    'ai.noBalance': 'ИИ: на счету нет средств (402)',
    'ai.rateLimited': 'ИИ: слишком часто (429) - попробую в следующий раз',
    'ai.badRequest': 'ИИ: запрос не принят (400)',
    'ai.serverDown': 'ИИ: сервер не отвечает (HTTP {status})',
    'ai.httpFailed': 'ИИ: запрос не удался (HTTP {status})',
    'ai.emptyAnswer': 'ИИ: пустой ответ',
    'ai.timeout': 'ИИ: ответа не дождались',
    'ai.error': 'ИИ: {error}',
    'ai.noTexts': 'Обновление текстов: нечего переписывать - тексты рассылки не загружены',
    'ai.disabled': 'Обновление текстов выключено в настройках',
    'ai.busy': 'Обновление текстов уже идёт - жду его окончания',
    'ai.started': 'Обновляю тексты рассылки через нейронку (язык {lang})',
    'ai.done': 'Тексты рассылки обновлены (обновление {n})',
    'ai.dropped': 'Прогон остановлен - обновлённые тексты не применяю',
    'ai.restored': 'Возвращены исходные тексты рассылки',
    'ai.noBaseline': 'Исходных текстов нет - возвращать нечего',
    'ai.badJson': 'ИИ: в ответе не нашлось JSON - тексты оставляю прежними',
    'ai.badModel': 'ИИ: модель не найдена (404) - проверьте её название в настройках',
    'ai.retryPlain': 'ИИ: провайдер не принял запрос - повторяю без лишних полей',
    // Причины отказа проверки. Пишутся вместе с ai.rejected.
    'ai.rejected': 'Ответ нейронки отклонён ({reason}) - тексты оставляю прежними',
    'ai.errRoot': 'в ответе не объект',
    'ai.errDict': 'нет словаря {dict} на нужном языке',
    'ai.errCount': 'в {dict} другое число вариантов',
    'ai.errEmpty': 'в {dict} пустой вариант',
    'ai.errHtml': 'в {dict} появилась разметка',
    'ai.errLong': 'в {dict} вариант вырос втрое',
    'ai.errSlot': 'в {dict} выдуманный плейсхолдер',
    'ai.errNoLink': 'в {dict} пропало место под ссылку',
  ...
  en: {
    ...
    'ai.noKey': 'AI: no API key set',
    'ai.badKey': 'AI: key rejected (401) - check it in settings',
    'ai.noBalance': 'AI: account has no funds (402)',
    'ai.rateLimited': 'AI: too many requests (429) - will try next time',
    'ai.badRequest': 'AI: request rejected (400)',
    'ai.serverDown': 'AI: server is down (HTTP {status})',
    'ai.httpFailed': 'AI: request failed (HTTP {status})',
    'ai.emptyAnswer': 'AI: empty answer',
    'ai.timeout': 'AI: answer timed out',
    'ai.error': 'AI: {error}',
    'ai.badModel': 'AI: model not found (404) - check its name in settings',
    'ai.retryPlain': 'AI: the provider rejected the request - retrying without the extra fields',
    'ai.noTexts': 'Text refresh: nothing to rewrite - outreach texts are not loaded',
    'ai.disabled': 'Text refresh is off in settings',
    'ai.busy': 'Text refresh is already running - waiting for it to finish',
    'ai.started': 'Refreshing outreach texts via the model (language {lang})',
    'ai.done': 'Outreach texts refreshed (refresh {n})',
    'ai.dropped': 'Run stopped - not applying the refreshed texts',
    'ai.restored': 'Original outreach texts restored',
    'ai.noBaseline': 'No original texts stored - nothing to restore',
    'ai.badJson': 'AI: no JSON found in the answer - keeping the current texts',
    'ai.rejected': 'Model answer rejected ({reason}) - keeping the current texts',
    'ai.errRoot': 'the answer is not an object',
    'ai.errDict': 'no {dict} for the needed language',
    'ai.errCount': '{dict} has a different number of variants',
    'ai.errEmpty': '{dict} has an empty variant',
    'ai.errHtml': '{dict} gained markup',
    'ai.errLong': 'a {dict} variant grew threefold',
    'ai.errSlot': '{dict} has an invented placeholder',
    'ai.errNoLink': '{dict} lost the link slot',
