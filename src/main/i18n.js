...
const DICT = {
  ru: {
    ...
    'ai.noKey': 'Deepseek: ключ API не задан',
    'ai.badKey': 'Deepseek: ключ не принят (401) - проверьте его в настройках',
    'ai.noBalance': 'Deepseek: на счету нет средств (402)',
    'ai.rateLimited': 'Deepseek: слишком часто (429) - попробую в следующий раз',
    'ai.badRequest': 'Deepseek: запрос не принят (400)',
    'ai.serverDown': 'Deepseek: сервер не отвечает (HTTP {status})',
    'ai.httpFailed': 'Deepseek: запрос не удался (HTTP {status})',
    'ai.emptyAnswer': 'Deepseek: пустой ответ',
    'ai.timeout': 'Deepseek: ответа не дождались',
    'ai.error': 'Deepseek: {error}',
    ...
    'ai.started': 'Обновляю тексты рассылки через Deepseek (язык {lang}, писем с прошлого раза: {n})',
    ...
    'ai.badJson': 'Deepseek прислал не JSON - тексты оставляю прежними',
  ...
  en: {
    ...
    'ai.noKey': 'Deepseek: no API key set',
    'ai.badKey': 'Deepseek: key rejected (401) - check it in settings',
    'ai.noBalance': 'Deepseek: account has no funds (402)',
    'ai.rateLimited': 'Deepseek: too many requests (429) - will try next time',
    'ai.badRequest': 'Deepseek: request rejected (400)',
    'ai.serverDown': 'Deepseek: server is down (HTTP {status})',
    'ai.httpFailed': 'Deepseek: request failed (HTTP {status})',
    'ai.emptyAnswer': 'Deepseek: empty answer',
    'ai.timeout': 'Deepseek: answer timed out',
    'ai.error': 'Deepseek: {error}',
    ...
    'ai.started': 'Refreshing outreach texts via Deepseek (language {lang}, messages since last time: {n})',
    ...
    'ai.badJson': 'Deepseek returned something other than JSON - keeping the current texts',
