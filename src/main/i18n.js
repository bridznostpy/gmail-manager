...
const DICT = {
  ru: {
    ...
    'gmail.listStale': 'Список писем не успел обновиться - пропускаю проход, чтобы не ответить повторно',
    'gmail.reloadFailed': 'Вкладку почты не удалось перезагрузить - пропускаю проход',
    ...
    'xp.taskFinished': 'XProject: задача {taskId} набрала свой предел объявлений и закрылась - заведу новую',
  ...
  en: {
    ...
    'gmail.listStale': 'Mail list did not settle in time - skipping this pass to avoid a duplicate reply',
    'gmail.reloadFailed': 'Could not reload the mailbox tab - skipping this pass',
    ...
    'xp.taskFinished': 'XProject: task {taskId} reached its listing limit and closed - starting a new one',
